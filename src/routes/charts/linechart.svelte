<script>
  ...
  $: exampleCode = data2
    ? `
import { LineChart } from "svelte-toolkit";
    ...
    <Table>
      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <td />
          <TableCell>The labels to display for each line</TableCell>
          <TableCell>
        ...
        <TableRow>
          <TableCell>showPoints</TableCell>
          <TableCell>true</TableCell>
          <TableCell>set to true to show points on the line, or false to hide them</TableCell>
          <TableCell>
            <label>
