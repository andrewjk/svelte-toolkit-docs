<script>
  ...
  let pages = [
    ...
    { group: "Components", title: "Table" },
    { group: "Components", title: "Tag" },
    { group: "Components", title: "Tag Input" },
    { group: "Nav", title: "Nav Bar" },
    { group: "Nav", title: "Sub Nav Menu" },
    { group: "Nav", title: "Switcher" },
    { group: "Nav", title: "Pagination" },
    { group: "Nav", title: "Dot Navigation" },
    { group: "Nav", title: "Story Navigation" },
